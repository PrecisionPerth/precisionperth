...
if(isset($_POST)) {
	...
	$mail->Username = "precisionperth.engineering"; // e-mail username
	$mail->Password = "LgI(mj0z6]ym"; // Mail password
	$mail->From = "precisionperth.engineering"; // Who is the mail from?
	$mail->FromName = "Web Form Mail | https://templatemonster.com/author/garantiwebt"; // Mailbox Incoming Header
	$mail->AddAddress("precisionperth@gmail.com"); // address to send mail
	$mail->Subject = "Contact Form Request - Precision Perth Engineering";
	$mail->IsHTML(true);
